            ...
            <div className={classes.root}>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} md={6} sm={12}>
                        <FoodItems data={data.products} total={data.totalPrice} />

                        <ListItem className={classes.listItem}>
                            <ListItemText primary="Shipping Fee" />
                            <Typography variant="subtitle1" className={classes.total}>
                                {formatter.format((data.delivery && data.delivery.price ? data.delivery.price : 0))}
                            </Typography>
                        </ListItem>
                        <ListItem>
                            <ListItemText
                            ...
                            <Typography variant="subtitle1" className={classes.deliveryPrice}>
                                {formatter.format(data.totalPrice + (data.delivery && data.delivery.price ? data.delivery.price : 0))}
                            </Typography>
                        </ListItem>
                    </Grid>
