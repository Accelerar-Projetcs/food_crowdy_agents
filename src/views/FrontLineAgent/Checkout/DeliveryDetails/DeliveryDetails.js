...
import { COMPANY_NAME, MOTORCYCLE, TRUCK } from "../../../../constants/brand";
...
const DeliveryDetails = ({ userId, activeStep, setActiveStep, setCheckoutData }) => {
    ...
    console.log(userId, activeStep, setActiveStep, setCheckoutData);
    ...
    const getCheapestLogisticsFee = (data) => {
        const lowetsPrices = data.reduce((min, value) =>
